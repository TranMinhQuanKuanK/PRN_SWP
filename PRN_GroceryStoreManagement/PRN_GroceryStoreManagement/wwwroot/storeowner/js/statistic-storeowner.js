...
function showProductStatistic() {
    ...
    url += "?date_from=" + document.getElementById("date-from-product").value;
    url += "&date_to=" + document.getElementById("date-to-product").value;
...
function showCustomerStatistic() {
    ...
    url += "?date_from=" + document.getElementById("date-from-customer").value;
    url += "&date_to=" + document.getElementById("date-to-customer").value;
...
function showFinancialStatistic() {
    ...
    url += "?date_from=" + document.getElementById("date-from-financial").value;
    url += "&date_to=" + document.getElementById("date-to-financial").value;
