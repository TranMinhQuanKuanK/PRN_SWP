...
function sendFeedback() {
    ...
    var feedback_content = encodeURIComponent(document.getElementById("feedback").value);
    var JSONObject = {
...
function passwordChange() {
    ...
    if (currentPassword.length > 1) {
        if (confirmNewPassword != newPassword) {
            ...
            var xhttp = new XMLHttpRequest();
            var currentPassword = encodeURIComponent(document.getElementById("currentPassword").value);
